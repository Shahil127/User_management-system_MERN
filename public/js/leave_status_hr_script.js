document.addEventListener('DOMContentLoaded', function() {
    ...
    const viewLeaveRecordsButton = document.getElementById('view-leave-records-btn');
    ...
    viewLeaveRecordsButton.addEventListener('click', function() {
      // Redirect to the Leave_Records.html page when the button is clicked
      window.location.href = 'Leave_Records.html';
    });
